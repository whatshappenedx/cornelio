...
const menuItems = [
  { key: 'generalSettings', label: 'Ajustes General ', icon: <SettingOutlined /> },
  //{ key: 'moneyFormatSettings', label: 'Ajustes de Moneda', icon: <SettingOutlined /> },
  //{ key: 'paymentSettings', label: 'Ajustes de Pago', icon: <CreditCardOutlined /> },
  //{ key: 'invoiceSettings', label: 'Ajustes de Factura', icon: <FileTextOutlined /> },
];
